========================================================================
    Win32 アプリケーション: HamSTART プロジェクトの概要
========================================================================

この HamSTART アプリケーションは、AppWizard により作成されました。
...
HamSTART.ico
    ...
    ファイルです。
    このアイコンは、メイン リソース ファイル HamSTART.rc 
    にインクルードされます。

small.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン 
    ファイルです。 このアイコンは、メイン リソース ファイル HamSTART.rc 
    にインクルードされます。
